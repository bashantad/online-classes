...
import hikerImg from '../../../assets/images/illustrations/knowledgebase-community-1.svg'
...
const TeachingEngineeringManager = () => {
    return (
        <>
            <div className="container space-top-3 space-top-lg-4 space-bottom-3 space-bottom-lg-4">
                    ...
                    <div className="col-md-6 col-lg-5">
                        <div className="mb-5">
                            ...
                            <p>Apply to teach for our community of students who wants to go to the next level. With your help, expertise and experience,
                                guide them to become a leading Engineering Manager.
                            </p>
                        </div>
...
export default TeachingEngineeringManager;
