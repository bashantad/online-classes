...
import hikerImg from '../../../assets/images/illustrations/hiker-man.svg'
import mobileArticle from '../../../assets/images/illustrations/chatting-man.svg'
import icon1 from '../../../assets/images/icons/icon-45.svg'
import icon2 from '../../../assets/images/icons/icon-14.svg'
import icon3 from '../../../assets/images/icons/icon-23.svg'
...
const EngineeringManager = () => {
    return (
        <>
            <div className="container space-top-3 space-top-lg-4 space-bottom-2 space-bottom-lg-4">
                <div className="row justify-content-lg-between mb-7">
                    <div className="col-md-6 col-lg-5">
                        <div className="mb-5">
                            <h1>Ready for the next step?</h1>
                            <p>Apply for our finely curated and specialized course designed specifically for professionals.
                            We will guide you to your goal of becoming an Engineering Manager
                            </p>
                        </div>

                        <div className="mb-3">
                            <a className="btn btn-primary btn-wide transition-3d-hover mb-2 mb-sm-0 mr-3" href="#">Apply Now</a>
            ...
            <div className="container space-2">
                <div className="w-lg-65 text-center mx-auto mb-5 mb-sm-9">
                    <h2 className="h1">What we offer?</h2>
                    <p>A flexible courses for Software Engineers</p>
                </div>
                ...
                <div className="row">
                    <div className="col-md-4 mb-7">
                        <div className="text-center px-lg-3">
                            ...
                            <p>Go through our courses ready-made for now as well as the future</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-7">
                        <div className="text-center px-lg-3">
                            ...
                            <p>Interactive learing with assignments and group chats.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-7">
                        <div className="text-center px-lg-3">
                            ...
                            <h3>Accelerate your domain</h3>
                            <p>We help power professionals to expand their knowledge horizon.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="position-relative text-center" id='mail'>
                <div class="container space-2 space-bottom-lg-4">
                    ...
                    <div class="d-none d-lg-block position-absolute bottom-0 left-4 max-w-19rem w-100">
