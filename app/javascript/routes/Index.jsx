...
const TeacherQuiz = lazy(() => import("../components/Quiz/Teacher"));
const StudentQuiz = lazy(() => import("../components/Quiz/Student"));
    ...
    <Router>
        <Suspense fallback={<Loading/>}>
            <Switch>
                ...
                <Route path="/quiz/teachers" exact component={TeacherQuiz}/>
                <Route path="/quiz/students" exact component={StudentQuiz}/>
                ...
                <Route path="/courses/:course_id/conversations/:conversation_id/messages" exact
